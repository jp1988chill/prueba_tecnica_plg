...
namespace Prueba.UnitTests
{
    ...
    public class PruebaUnitTest
    {
        ...
        public void TestEFCoreOperation()
        {
            ...
            for (i = 0; i < 10; i++)
            {
                dbCtx.Users.Add(new Cliente(name: "TestName" + i, password: "TestPassword" + i, token: new Guid(), tokenleasetime: DateTime.Now.AddSeconds(60 * 10).ToString("dd-MM-yyyy HH:mm:ss")));
                dbCtx.SaveChanges();
            }
